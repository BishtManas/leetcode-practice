...
if __name__ == "__main__":
    sol = Solution()
    print(f"Answer is : {sol.largestSquareArea(bottomLeft = [[1,1],[2,2],[3,1]], topRight = [[3,3],[4,4],[6,6]])}")
    print(f"Answer is : {sol.largestSquareArea(bottomLeft = [[1,1],[1,3],[1,5]], topRight = [[5,5],[5,7],[5,9]])}")
